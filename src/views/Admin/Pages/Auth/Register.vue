        ...
        <div class="flex flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-0 mr-auto mb-0 ml-auto max-w-7xl
            ...
            <div class="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
                ...
                <div class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                    ...
                    <div class="relative">
                    <p class="bg-white pt-0 pr-2 pb-0 pl-2 -mt-3 mr-0 mb-0 ml-2 font-medium text-gray-600
                        absolute">Password Confirmation</p>
                    ...
                    <button type="submit" class="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-teal-900
                        rounded-lg transition duration-200 hover:bg-teal-600 ease hover:cursor-pointer">Submit</button>
                    </div>
                    </form>
                    <div class="relative">
                        <router-link :to="{name: 'Login'}" class="hover:text-teal-600 underline underline-offset-8 hover:cursor-pointer">
