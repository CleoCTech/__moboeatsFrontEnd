            ...
            <div class="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
                ...
                <div class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                    ...
                    <button type="submit" class="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-teal-900
                        rounded-lg transition duration-200 hover:bg-teal-600 ease hover:cursor-pointer">Login</button>
                    </div>

                    </form>

                    <div class="relative flex">
                        <router-link :to="{name: 'ForgotPassword'}" class="hover:text-teal-600 underline underline-offset-8 hover:cursor-pointer">
                            <p>Forgot Password?</p>
                        </router-link>

                        <router-link :to="{name: 'Register'}" class="ml-auto hover:text-teal-600 underline underline-offset-8 hover:cursor-pointer">
                            <p>Create account</p>
                        </router-link>
                    </div>
                </div>
                ...
                <svg viewbox="0 0 91 91" class="absolute bottom-0 right-0 z-0 w-32 h-32 -mb-12 -mr-12 text-teal-500
                    fill-current"><g stroke="none" strokewidth="1" fillrule="evenodd"><g fillrule="nonzero"><g><g><circle
                    cx="3.261" cy="3.445" r="2.72"/><circle cx="15.296" cy="3.445" r="2.719"/><circle cx="27.333" cy="3.445"
                    r="2.72"/><circle cx="39.369" cy="3.445" r="2.72"/><circle cx="51.405" cy="3.445" r="2.72"/><circle cx="63.441"
                    cy="3.445" r="2.72"/><circle cx="75.479" cy="3.445" r="2.72"/><circle cx="87.514" cy="3.445" r="2.719"/></g><g
