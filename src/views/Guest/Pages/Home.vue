...
<template>
    ...
    <div class="container max-w-5xl mx-auto ">
        <div class="w-4/5">
        <h1 class="mt-32 text-white text-6xl font-bold">Mobeats, most secure dev environment <br /><span class="text-blue-400">on the planet.</span></h1>
        </div>
        ...
        <div class="text-center lg:text-left">
            <a
                class="block visible py-4 px-8 mb-4 text-xs font-semibold tracking-wide leading-none text-white bg-teal-700 rounded cursor-pointer sm:mr-3 sm:mb-0 sm:inline-block hover:cursor-pointer"
                >Get started</a
            >

            <a
                class="block visible py-4 px-8 text-xs font-semibold leading-none bg-white rounded border border-solid cursor-pointer sm:inline-block border-slate-200 text-teal-500 hover:cursor-pointer"
                >How We Work?</a
            >
        </div>
        ...
        <h3 class="text-uppercase font-semibold">Our Services</h3>
